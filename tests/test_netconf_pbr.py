...
class Checks(unittest.TestCase):
    ...
    def test_namespace_keys_and_policy(self):
        ...
        self.assertEqual(xml.xpath('//c:policy[c:name="SSE-POLICY"]/c:match/c:address/c:local-ip/text()',namespaces=ns),['192.0.2.110'])
    ...
    def test_packet_classification_and_order(self):
        ...
        for destination in ['10.77.10.9','10.77.11.9','10.77.100.9']:
            self.assertFalse(classify('10.77.15.9',destination))
        self.assertTrue(classify('10.77.15.9','203.0.113.20'))
        self.assertFalse(classify('198.51.100.9','8.8.8.8'))
    ...
    def test_preserve_rib(self):
        ...
        self.assertEqual(xml.xpath('//n:fwd-list/n:fwd/text()',namespaces=ns),['192.0.2.1'])
