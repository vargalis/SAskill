# Исторический проект архитектуры: этап 1

Это исходный проект, а не описание текущей реализации или инструкция оператора.
Актуальный процесс: [English](user-guide.en.md), [Русский](user-guide.ru.md),
[транзакции](netconf-apply.md). Указания ниже об отсутствии apply относятся к этапу 1.
