...
Полный текущий CSV-процесс, установка и ограничения: [Русский](user-guide.ru.md),
[English](user-guide.en.md). Wizard — необязательный интерфейс планирования;
описания отсутствующего apply ниже относятся к wizard/preview, а не к текущим
MCP-инструментам CSV-транзакций. Для применения используйте руководства.
